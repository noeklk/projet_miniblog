...
<h1 align="center" class="">Projet n°4 Noé - admin login</h1>
   ...
   <div class="form-group">
        ...
        <form id="formulaire" action="acceslogin.php" method="post">
                ...
                id : <input type="text" name="LOGIN_ID" maxlength="15" style="width: 150px" placeholder="LOGIN">
                <br><br>
                   
                mdp : <input type="password" name="LOGIN_MDP" maxlength="15" placeholder="PASSWORD">
                <br><br>
