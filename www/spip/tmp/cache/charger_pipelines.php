...
include_once_check(_ROOT_PLUGINS.'auto/skeleditor/v3.0.1/skeleditor_options.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/skeleditor/v3.0.1/inc/skeleditor_autoriser.php');
