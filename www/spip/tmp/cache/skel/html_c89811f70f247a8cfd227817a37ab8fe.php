...
function BOUCLE_artsrhtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('=', 'articles.statut', sql_quote(interdire_scripts($Pile[$SP-2]['valeur']), '', 'varchar(10) NOT NULL DEFAULT \'0\'')), sql_in('articles.id_rubrique', calcul_branche_in(sql_quote($Pile[$SP]['id_rubrique'], '', 'int NOT NULL'))));
...
// Temps de compilation total: 4.130 ms
//
