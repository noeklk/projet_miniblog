...
// Temps de compilation total: 6.445 ms
//
...
'<'.'?php header(' . _q('Vary: Accept-Encoding') . '); ?'.'>#bando_haut { /*font-size: 1em;*/ position: relative; z-index: 1001;}
...
#bando_haut ul.deroulant li.non_favori { background-color: #' .
interdire_scripts(filtrer('couleur_eclaircir',entites_html(table_valeur(@$Pile[0], (string)'claire', null),true),'.92')) .
'; }
...
#bando_outils li.plan_site {margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
':20px;}
...
#bando_outils li.plan_site a .image_loading {float:' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
';}
...
.navigation .sous_navigation .item.non_favori { background-color: #' .
interdire_scripts(filtrer('couleur_eclaircir',entites_html(table_valeur(@$Pile[0], (string)'claire', null),true),'.92')) .
'; }
.navigation .sous_navigation .item.on { background-color:' .
