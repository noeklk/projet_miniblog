...
// Temps de compilation total: 8.007 ms
//
...
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = strdiv(strdiv(strplus(table_valeur($Pile["vars"], (string)'line-height', null),'2'),'2'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = strdiv('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
'h1,.h1 {' .
(($t1 = strval(strmult(table_valeur($Pile["vars"], (string)'line-height', null),table_valeur($Pile["vars"], (string)'coeff', null))))!=='' ?
		(' font-size: ' . $t1 . 'em') :
		'') .
';' .
(($t1 = strval(strmult(table_valeur($Pile["vars"], (string)'coeffinv', null),'2')))!=='' ?
		(' line-height: ' . $t1 . 'em') :
		'') .
';' .
...
'}
h2,.h2 {' .
(($t1 = strval(strmult(table_valeur($Pile["vars"], (string)'line-height', null),'1')))!=='' ?
		(' font-size: ' . $t1 . 'em') :
		'') .
'; line-height: 1; margin-bottom: 1em; font-weight: bold;}
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = strdiv(strdiv(strplus(table_valeur($Pile["vars"], (string)'line-height', null),'1'),'2'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = strdiv('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
'h3,.h3 {' .
(($t1 = strval(strmult(table_valeur($Pile["vars"], (string)'line-height', null),table_valeur($Pile["vars"], (string)'coeff', null))))!=='' ?
		(' font-size: ' . $t1 . 'em') :
...
'font-weight: bold; }
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = strdiv(strdiv(strplus(table_valeur($Pile["vars"], (string)'line-height', null),'3'),'4'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = strdiv('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
...
(($t1 = strval(interdire_scripts(strdiv(strdiv(strmult(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'1.5'),'2'),table_valeur($Pile["vars"], (string)'line-height', null)))))!=='' ?
		($t1 . 'em') :
		'') .
'}
...
th,td,caption {' .
(($t1 = strval(strdiv(table_valeur($Pile["vars"], (string)'line-height', null),'2')))!=='' ?
		(' padding: ' . $t1 . 'em;') :
		'') .
' }
...
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
':' .
(($t1 = strval(interdire_scripts(strdiv(entites_html(table_valeur(@$Pile[0], (string)'text-indent', null),true),'2'))))!=='' ?
		($t1 . 'px') :
		'') .
';}
