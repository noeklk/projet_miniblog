...
// Temps de compilation total: 3.789 ms
//
...
((table_valeur($Pile["vars"], (string)'objet_exec', null))  ?
		(' ' . (	'
	' .
	vide($Pile['vars'][$_zzz=(string)'objet'] = table_valeur($Pile["vars"], (string)'objet_exec/type', null)) .
	vide($Pile['vars'][$_zzz=(string)'id_objet'] = interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)table_valeur($Pile["vars"], (string)'objet_exec/id_table_objet', null), null),true))) .
