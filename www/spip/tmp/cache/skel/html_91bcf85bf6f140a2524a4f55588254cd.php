...
// Temps de compilation total: 4.691 ms
//
...
';height: ' .
(($t1 = strval(interdire_scripts(strdiv(strmult(entites_html(table_valeur(@$Pile[0], (string)'line-height', null),true),'2'),table_valeur($Pile["vars"], (string)'iconfontsize', null)))))!=='' ?
		($t1 . 'em') :
		'') .
';line-height:1; }
...
(($t1 = strval(interdire_scripts(strdiv(strmult(entites_html(table_valeur(@$Pile[0], (string)'line-height', null),true),'3'),table_valeur($Pile["vars"], (string)'iconfontsize', null)))))!=='' ?
		($t1 . 'em') :
		'') .
';}
