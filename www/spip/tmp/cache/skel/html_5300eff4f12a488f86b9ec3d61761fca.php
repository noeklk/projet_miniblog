...
// Temps de compilation total: 3.074 ms
//
...
':40px;min-height:24px;background-repeat:no-repeat;background-position: ' .
...
(($t1 = strval(interdire_scripts(strmult(entites_html(table_valeur(@$Pile[0], (string)'line-height', null),true),'1'))))!=='' ?
		($t1 . 'em') :
		'') .
