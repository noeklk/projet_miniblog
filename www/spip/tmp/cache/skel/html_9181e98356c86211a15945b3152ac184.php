...
// Temps de compilation total: 2.200 ms
//
...
(($t1 = strval(interdire_scripts(strdiv(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'0.9'))))!=='' ?
		($t1 . 'em') :
		'') .
';padding-top:' .
(($t1 = strval(interdire_scripts(strdiv(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'0.9'))))!=='' ?
...
(($t1 = strval(interdire_scripts(strmult(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'0.5'))))!=='' ?
		($t1 . 'em') :
		'') .
';}
...
(($t1 = strval(interdire_scripts(strmult(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'1.0'))))!=='' ?
		($t1 . 'em') :
		'') .
';}
